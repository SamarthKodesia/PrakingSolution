...
import { StyleSheet, Text, View, Image, ScrollView,Alert, KeyboardAvoidingView, TextInput, TouchableOpacity, FlatList, AsyncStorage } from 'react-native';
import {
  widthPercentageToDP,
...
export default class events extends React.Component {
  ...
  componentWillMount() {
    ...
    var data = [
      {
        "event_name": "No. 815",
        "event_date": "Permanent",
        "club": "Invoice Id: 2863922836292",
        "color_label": "#4285f4"

      },
      {
        "event_name": "NO. 816",
        "event_date": "15th Dec 2019 - 15th Dec 2020",
        "club": "Invoice Id: 2863922836292",
        "color_label": "#cd006d"
      },
    ];
