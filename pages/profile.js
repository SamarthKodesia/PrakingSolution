...
import { StyleSheet, Text, View, Image, ScrollView, KeyboardAvoidingView, TextInput, TouchableOpacity, FlatList, AsyncStorage } from 'react-native';
import {
  widthPercentageToDP,
...
export default class events extends React.Component {
  ...
  myInfo(){
      return(
        ...
        <Text style={[styles.data_text,{marginTop:40}]}>Flat No.                : 1803</Text>
        <Text style={styles.data_text}>Block                      : E</Text>
        <Text style={styles.data_text}>Contact No.      : 8648723334</Text>
        <Text style={styles.data_text}>Cars Owned     : 2</Text>
        <Text style={styles.data_text}>Parkings             : 2</Text>
        </View>
      );
  }
  eventsList() {
